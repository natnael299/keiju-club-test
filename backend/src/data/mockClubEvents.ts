...
export const mockClubEvents: ClubEvent[] = [
  {
    ...
    registrationUrl: "https://example.com/register/chair-yoga",
...

  {
    ...
    registrationUrl: "https://example.com/register/museum-visit",
